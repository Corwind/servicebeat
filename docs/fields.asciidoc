...
--
This document describes the fields that are exported by Servicebeat. They are
...
The command to run that checks service status
...
The regex to match the output of the command
